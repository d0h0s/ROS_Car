//
// Created by 86136 on 2024/3/1.
//

#ifndef MECANUM_CART_MPU6050_TASK_H
#define MECANUM_CART_MPU6050_TASK_H
#include "main.h"
#define devAddr 0xD0
...
uint8_t MPU6050_testConnection(void);   // ?¨¬??MPU6050??¡¤?????
...
void MPU6050_getlastMotion6(int16_t *ax, int16_t *ay, int16_t *az, int16_t *gx,
                            int16_t *gy, int16_t *gz);
uint8_t MPU6050_getDeviceID(void);  // ????MPU6050??ID
...
#endif // MECANUM_CART_MPU6050_TASK_H
